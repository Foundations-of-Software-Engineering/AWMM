...
//
//		// Test LOGIN
//		Message newUserMessage = new ExampleMessage(null, 0, "LOGIN", null, null, null);
...
//		newUserMessage = new ExampleMessage(gameID, 1, "LOGIN", null, null, null);
...
//
//		// Test MOVE
//		Message moveMessage = new ExampleMessage(gameID, 0, "MOVE", "RIGHT", null, null);
//		textMessage = new TextMessage(clientController.convertToJson(moveMessage));
//		clientController.handleTextMessage(session, textMessage);
//		moveMessage = new ExampleMessage(gameID, 1, "MOVE", "DOWN", null, null);
//		textMessage = new TextMessage(clientController.convertToJson(moveMessage));
//		clientController.handleTextMessage(session, textMessage);
//		System.out.println("gameState for gameID " + gameID + " is\n" + clientController.getGameState(gameID));
//
...
//
//		// Test START
//		Message startMessage = new ExampleMessage(gameID, 0, "START", null, null, null);
