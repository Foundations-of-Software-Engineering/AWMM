    ...
    form.addEventListener("submit", function (event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, sendMessage_js_1.sendMessage)({ gameID: gameID, userID: userID, action: action })];
                case 2:
                    _a.sent();
